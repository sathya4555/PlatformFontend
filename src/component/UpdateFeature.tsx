...
export const UpdateFeature = (props: { name: string, getFeature: any[] }) => {
    ...
    const [featurename, setrolename] = useState('')

    const [editID, seteditID] = useState('')
    const [editRolename, seteditRolename] = useState('')
    const [appdesc, setappdesc] = useState('')
    const [featuredesciption, setmethodname] = useState('')
